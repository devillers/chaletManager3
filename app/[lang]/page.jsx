...
export default function HomePage({ params }) {
  ...
  return (
    <div>
      <section className="relative overflow-hidden bg-neutral-900 py-24 text-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col gap-6 px-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              {params.lang === "fr" ? "Créer un compte" : "Create an account"}
            </a>
          </div>
        </div>
      </section>
      <Section title={params.lang === "fr" ? "Pourquoi Chalet Manager ?" : "Why Chalet Manager?"}>
        <p>
          {params.lang === "fr"
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              title: params.lang === "fr" ? "Accompagnement humain" : "Human support",
              text:
                params.lang === "fr"
            ...
            {
              title: params.lang === "fr" ? "Expérience locataire" : "Guest experience",
              text:
                params.lang === "fr"
            ...
            {
              title: params.lang === "fr" ? "Technologie PWA" : "PWA technology",
              text:
                params.lang === "fr"
      ...
      <Section title={params.lang === "fr" ? "Témoignages" : "Testimonials"}>
          ...
          {[
            {
              ...
              author: params.lang === "fr" ? "Sophie, propriétaire" : "Sophie, owner",
            },
            {
              quote:
                params.lang === "fr"
              ...
              author: params.lang === "fr" ? "Alexandre, locataire" : "Alexander, guest",
            },
          ].map((item) => (
